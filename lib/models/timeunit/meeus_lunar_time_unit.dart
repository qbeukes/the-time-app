...
class MeeusLunarTimeUnit extends LunarTimeUnit {
  const MeeusLunarTimeUnit(super.epochMilliseconds);

  // ─── Internal epoch helpers ───────────────────────────────────────────────

  /// J2000.0 Julian Day Number (2000-01-01 12:00:00 TT)
  static const double _j2000JDE = 2451545.0;

  /// J2000.0 as Unix milliseconds (2000-01-01 12:00:00 TT)
  static const int _j2000Ms = 946728000000;

  /// Meeus k=0 new-moon reference JDE (≈ 2000-01-06 14:21 TT)
  ...
  static double _msToJDE(int ms) => (ms - _j2000Ms) / 86400000.0 + _j2000JDE;
  ...
  LunarTimeUnit previousFullMoon() {
    ...
    return MeeusLunarTimeUnit(_jdeToMs(jde));
  }
  ...
  /// Offset to shift the logical epoch of [fullMoonIndex].
  static const int baseFullMoonIndexOffset = 0;

  @override
  int get fullMoonIndex {
    final kNowInt = (_kContinuous() - 0.5).floor();
    return kNowInt + baseFullMoonIndexOffset;
  }
